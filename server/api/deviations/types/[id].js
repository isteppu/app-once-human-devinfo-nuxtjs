...
export default defineEventHandler(async (event) => {
    ...
    if (method === 'get') {
        return handleDatabaseOperation(`DeviationTypes/${id}`, 'get');
    } else if (method === 'put') {
        const putData = await readBody(event);
        return handleDatabaseOperation(`DeviationTypes/${id}`, 'put', putData);
    } else if (method === 'delete') {
        return handleDatabaseOperation(`DeviationTypes/${id}`, 'delete');
    } else {
